...
class POPArticalDetailsScreen extends StatelessWidget {
  static const String routname = 'POPArticalDetailsScreen';

  @override
  Widget build(BuildContext context) {
    POPResults articles = ModalRoute.of(context)!.settings.arguments as POPResults;
